...
interface ProjectConfigComponentProps {
    audioFiles: FileItem[]
    images: FileItem[]
...
export function ProjectConfigComponent({ audioFiles, images, onProcessingUpdate }: ProjectConfigComponentProps) {
    ...
    const totalDuration = useMemo(() => {
        const singleLoopDuration = audioFiles.reduce((acc, file) => acc + (file.duration || 0), 0)
    ...
    const onSubmit = async (data: FormData) => {
        if (!isElectron) {
            toast({
                ...
                description: "Video processing requires the desktop version of the app.",
            })
            return
        }
        ...
        try {
            ...
            if (result.success) {
                toast({
                    ...
                    description: `Video saved to: ${result.outputPath}`,
                })
            ...
            <CardContent>
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg border">
                    ...
                    {outputDirectory ? (
                        ...
                        <p className="text-sm text-gray-500 italic">
                            {isElectron
                                ? "No output directory selected. Videos will be saved to a folder you choose."
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="videoLength" className="font-medium text-gray-700">
                                Estimated Length
                            </Label>
                            <div
                                id="videoLength"
                                className="flex items-center justify-center h-10 w-full rounded-md border border-input bg-gray-100 px-3 py-2 text-sm text-muted-foreground"
                            >
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    {(progress.stage === "processing-video" ||
                                        progress.stage === "processing-audio" ||
                                        progress.stage === "finalizing") && (
                                        <span className="text-xs text-blue-600 animate-pulse">
                                            ⚡ Check terminal window for live progress
                                        </span>
                                    )}
                                </div>
